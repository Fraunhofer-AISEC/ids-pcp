...
if [ "$#" != "2" ] && [ "$#" != "4" ] && [ "$#" != "7" ] && [ "$#" != "8" ]; then
	...
	./pcp.sh <pki-dir> ca
		Sets up the folder <pki-dir> with the initial root CA as well as two intermediary CAs for users and devices and prepares the database for the OCSP servers. 
